...
export async function getServerSideProps() {
  ...
  let varients = await Product.find({ category: 'mug' })
  let products = {}
    ...
    <div>
      ...
      <div className="container px-5 py-24 mx-auto">
        ...
        {Object.keys(products).length != 0 ?
                      ...
                      <div className="p-2 flex flex-col row-span-2 justify-center">
                        ...
                        <p className="text-slate-400 text-base my-1">
                          {products[product].size.map((size) => {
                            return <span className='mx-1'>{size.toUpperCase()}</span>
                          })}
                        </p>
          ...
          </div> : <div className='text-lg text-center'>Sorry, No Mug Avilable <span className='font-bold text-[#0f0]'>Right Now</span></div>}
