...
export async function getServerSideProps() {
  ...
  let varients = await Product.find({ category: 'tshirt' })
  let products = {}
...
const Tshirts = ({ products }) => {
  ...
  return (
    <div>
      <Head>
        <title>Tshirts | Hackerwear</title>
      </Head>
      <div className="container px-5 py-24 mx-auto">

        {Object.keys(products).length != 0 ?
          <div className="sm:p-10 grid justify-center content-center grid-cols-1 sm:grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-5">
          ...
          </div> : <div className='text-lg text-center'>Sorry, No Tshirt Avilable <span className='font-bold text-[#0f0]'>Right Now</span></div>}
